...
export const HomeView = ({ tabSelection, onTabChanged, pluginsView, topicsView, devicesView, onDeletePlugin, onDeleteTopic, onDeleteDevice }) => {
    return (
        <Tabs value={tabSelection} onChange={onTabChanged}>
            <Tab value={0} label="Plugins">
                <PluginsView loading={pluginsView.loading} plugins={pluginsView.plugins} onDelete={onDeletePlugin} />
            </Tab>
            <Tab value={1} label="Topics">
                <TopicsView loading={topicsView.loading} topics={topicsView.topics} onDelete={onDeleteTopic} />
            </Tab>
